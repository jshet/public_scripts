...
with st.expander("Colors"):
    ...
    with col1:
        ...
        st.session_state.fill_color = st.color_picker('Click it', value=st.session_state.fill_color)
    with col2:
        ...
        st.session_state.back_color = st.color_picker('Click it', value=st.session_state.back_color)

with st.expander("Size and border"):
